...
هنگام برنامه‌نویسی وب که می‌خواهیم کدهای ما در 
browser 
...
library که به آن وابستگی داریم می‌تواند به libraryهای دیگری وابستگی داشته باشد. برای مدیریت این وابستگی‌های تو در تو به این صورت که مثلا چند بار کدهای یکسانی را load نکنیم نیاز به ابزار داریم.
