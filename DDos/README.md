...
<p dir="rtl">
حملات DDoS با شبکه‌ای از دستگاه‌های متصل به اینترنت انجام می‌شود. هر کدام از دستگاه‌های مورد استفاده مهاجم می‌توانند رایانه‌ای آلوده، مودم، دستگاه‌های ‌IoT یا هر منبع شبکه دیگری باشند که به بدافزار آلوده شده‌اند و به آن‌ها اجازه می‌دهند از راه دور توسط یک مهاجم کنترل شوند.</p>
