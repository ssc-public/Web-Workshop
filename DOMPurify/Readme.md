...
یکی از راه‌های جلوگیری از این نوع حملات استفاده از کتابخانه‌هایی هستند که می‌توانند درخواست‌های آلوده یا محتویات فایل‌های HTML‌ای که آلوده شده‌اند را پاکسازی کنند. DOM Purify یکی از محبوب‌ترین کتابخانه‌‌های مورد استفاده برای شناسایی و رفع آلودگی‌ها است تا از حملات احتمالی جلوگیری کند.
 ...
 ## DOM purify
همان‌طور که از نام آن مشخص است، این کتابخانه می‌تواند با بررسی  مدل درختی، قسمت‌های آلوده را شناسایی و اصلاح کند. در ادامه چند مثال از نحوه عملکرد  DOM purify را مشاهده می‌کنید.
...
به دلیل آنکه در سمت سرور به DOM دسترسی نداریم لازم است تا یک DOM را در سمت سرور بسازیم. یکی از راه‌های ساختن، استفاده از کتابخانه jsdom است. با کمک این کتابخانه می‌توانیم آبجکت‌های آلوده را در سمت سرور نیز شناسایی کنیم تا از به‌روز حملاتی مانند reflected XSS‌ها و stored XSS‌ها جلوگیری کنیم.
