...
مثلا یک دیتابیس مربوط به هواشناسی را در نظر بگیرید؛ داده‌های درون این دیتابیس شامل داده‌هایی هستند که در هر ساعت درحال تغییراند و با توجه به تغییرات قبلی تغییرات احتمالی آینده باید پیشبینی شود.
<br /><br />
...
<br/>
 مثال نوارقلب بیمار را در نظر بگیرید؛ ممکن است تغییرات ناگهانی در هر لحظه در آن رخ دهد پس ما تناوب این تغییرات را نمی‌دانیم اما نیاز به ثبت تمامی آنها داریم.
<br/><br/>
