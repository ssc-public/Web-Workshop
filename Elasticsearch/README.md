...
برخی از انواع مهم کوئری‌های الستیک‌سرچ عبارتند از:
  - Match Query: در مثال زیر دنبال اسنادی می‌گردیم که در body آن‌ها کلیدواژه‌ی `quis` یافت شود (و 5 سند پیدا می‌کند)
  ...
  - Range Query: برای مثال اگر بخواهیم پست‌هایی که userId آن‌ها بین 1 و 5 است را مشاهده کنیم...:
  <div dir="ltr">
  ...
  - Bool Query: با استفاده از این نوع جستار می‌توان با سایر کوئری‌ها یک ترکیب منطقی از آنان را جستجو کرد. مثلاً در این مثال از اسناد جستجوی قبلی آن‌هایی انتخاب می‌شوند که userId آن‌ها 2 نباشد: 
  <div dir="ltr">
