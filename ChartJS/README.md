...
می‌توانید آخرین نسخه از Chart.js را به صورت مستقیم از صفحه GitHub این پروژه دانلود کنید. توجه کنید که در صورت استفاده از این روش باید پروژه را Build کنید تا فایل های dist برای استفاده بدست بیایند. لذا استفاده از روش جایگزین قویا توصیه میشود.
...
| نام               | نوع     | حالت پیشفرض | توضیحات                                                                                              |
| ----------------- | ------- | ----------- | ---------------------------------------------------------------------------------------------------- |
| mode              | string  | 'nearest'   | تعیین می‌کند کدام المان ها در tooltip قرار داده میتوضیحاتشوند.                                        |
...
| fill            | پر کردن زیر خط                                                                                           |
| spanGaps        | اگر false باشد، دیتای NaN یا Null موجب شکستگی در خط میشود، در غیر این صورت، خط پیوستگی خود را حفظ می‌کند. |
