...
##نویسندگان
این نوشته توسط دوگروه مستقل از هم نگاشته شده و در نهایت حاصل آنها با یکدیگر ادغام شده است. فایل ها نوشته ها گروه هارا به تفکیک می توانید در پوشه groups مشاهده کنید.
