...
8. این یک قابلیت امنیتی برای تغییر نام دستورهای خطرناک است. در صورتی که تمایلی به انجام آن ندارید، می‌توانید این بخش را دنبال نکنید.
   یک قابلیت امنیتی دیگر که ردیس فراهم می آورد. تغییر نام یا غیرفعال کردن دستوراتی است که اجرای آنها می‌تواند خطرناک باشد.
...
- sorted set در این مرحله دیدیم که با استفاده از sorted set و بهره بردن از مزایای خاص این داده ساختار می‌توانیم، مرتب‌سازی کاربران براساس امتیاز آنها را به صورت یک پیش پردازش داشته باشیم که در هر لحظه بتوان درخواست ها را به سرعت جواب داد. همچنین با استفاده از این داده ساختار، عملیات هایی مانند پیدا کردن کاربران در یک بازۀ رتبه یا پیدا کردن کاربران در یک بازۀ امتیاز و ... به راحتی قابل انجام است که این امر در نمایش یک جدول پویا و دلخواه به ما کمک می‌کند.
