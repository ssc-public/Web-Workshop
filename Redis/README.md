...
استفاده از این روش، به دلیل سادگی و سهولت قویا توصیه میشود. با طی مراحل زیر، می‌توانید ردیس را در داکر خود نصب کنید.
...
<<<<<<< HEAD
در صورتی که میخواهید عناصر خروجی گرفته شده از دستور `SRANDMEMBER` حذف شود، می‌توانید به جای این دستور از دستور زیر استفاده کنید.
=======
