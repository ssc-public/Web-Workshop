...
```
با داشتن نقاط میتوان از بین آن ها یک منحنی رد کرد. ابتدا کلاس Path را ایجاد کرده سپس نقاط را با تابع add اضافه می‌کنیم. 
```JS
<div dir="rtl">
var myPath = new Path();
myPath.add(myPoint);
...
در روش اول نقطهی بالا سمت چپ مستطیل مشخص میشود سپس سایز آن را مشخص می‌کنیم. در انتها با این دو وی×گی مستطیل را میسازیم.
