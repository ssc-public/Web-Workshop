...
# توضیحات کلی
.دارت یک زبان بهینه سازی شده برای کلاینت به هدف توسعه برنامه های سریع در پلتفرم های گوناگون است که توسط گوگل توسعه داده شده است . هدف دارت ارائه کردن بهینه ترین زبان برای توسعه چند پلتفرمی است که دارای پلتفرم زمان اجرای انعطاف پذیر نیز باشد. 
