...
یعنی همانطور که در مثال بالا دیده می‌شود instance ای از مدل x را باید به عنوان ورودی Xserializer داد
...
مدل Channel دارای ۴ فیلد است که هر کدام ویژگی خاص دارند که جلوتر به شرح آن‌ها میپردازیم.
 ...
 همانطور که مشاهده می‌کنید برای ساختن serializer ابتدا باید ان را از ‍‍`rest_framework` ایمپورت کرد.
