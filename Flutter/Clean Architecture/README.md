...
سرویس‌هایی که پیش از ران شدن اپ به آنها نیاز داریم را راه‌اندازی می‌کنیم و سپس یک متدکال بسیار مهم داریم! initSl یکی از مهم‌ترین بخش‌های معماری شما است که تمام کلاس‌هایی که تنها یک instance از آنها نیازدارید را داخل یک سرویس راه‌اندازی میکند. برای اینکار شما میتوانستید از singleton design pattern نیز استفاده کنید اما روش بهتر همین روشی است که ما در این آموزش معرفی می‌کنیم: 
