...
در این نوشته در مورد روش‌های توسعه با تست صحبت نشده است و همه چیز با همان روش عادی کد زدن جلو میرود. قبل از خواندن ادامه مقاله مطمئن باشید که چیز‌هایی از خود فریم‌ورک فلاتر بلد هستید. می‌توانید یک ماشین حساب ساده با فلاتر بنویسید. میدانید استیت چیست و چطور مدیریت میشود. یکی دو روش مدیریت استیت در فلاتر را بلد باشید. یک اپلیکیشن ساده برای دریافت پاسخ از سورس‌های آنلاین هم بلد باشید که بنویسد.
