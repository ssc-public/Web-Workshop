...
یک کتابخانه‌ی تقریبا کامل http شامل درخواست‌های get, put, patch, delete, post است. بیایید فرض کنیم میخواهیم مطمئن باشیم که این متد‌ها را پیاده کرده‌ایم و حتما قادر هستیم از آنها استفاده کنیم. بنابراین یک اینترفیس بر این مبنی مینویسیم:
