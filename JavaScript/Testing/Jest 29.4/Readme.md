...
بر اساس پروژه شما، Jest از شما چند سؤال می‌پرسد و یک فایل پیکربندی اولیه با توضیحات کوتاه برای هر گزینه ایجاد می‌کند:</p>
...
همان طور که گفته شد، با استفاده از این ویژگی می‌توان نحوه صدا زده شدن توابع، ایجاد شدن آنها و نتیچه ی برگشته شده از آنها را بررسی کرد:
