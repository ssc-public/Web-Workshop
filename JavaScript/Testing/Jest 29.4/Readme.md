...
<p>در کدی که در ادامه مشاهده می‌کنید ما یک تابع داریم که دو عدد را ورودی میگیرد و آنها را با هم جمع می‌کند و در نهایت خروجی میدهد.</p>
...
این کار می‌تواند دردسرزا باشد مخصوصا اگر تنظیمات آسنکرون باشند، چون نمی‌توان به صورت inline آنها را انجام داد.
