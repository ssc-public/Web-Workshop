...
## env. 
برای Customize کردن مقادیر بر اساس نوع انتشار برنامه (production, development, ...) و نگه داشتن اطلاعات مهم و حساس مانند پسوورد ها و API Key ها استفاده می‌شود. این فایل در gitignore قرار داده می‌شود تا بقیه به اطلاعات آن دسترسی نداشته باشند.
