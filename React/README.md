...
کاری که React در آن به ما کمک می‌کند این است که بجای استفاده از المان های پیشفرض در HTML، می‌توانیم خودمون تعدادی Component تعریف کنیم و از آنها استفاده کنیم. با Component ها در ادامه آشنا میشویم. اگر یک Component کلی، مثلا با نام App برای پروژه مان تعریف کنیم، این‌گونه می‌توانیم آنرا در کد قرار دهیم تا در صفحه نشان داده شود:
