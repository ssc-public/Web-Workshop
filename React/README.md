...
اتفاقی که داخل بدنه React میفته اینه که ما میایم و هر جزئی رو یک شیء در نظر میگیریم اما نه شیئی که از به هم اضافه کردن کلی المنت ساخته شده باشه بلکه اون شیء به کمک چند خط html ساخته شده
...
برای استفاده از Hooks باید از useState استفاده کنیم و به عنوان ورودی به آن مقدار اولیه state را بدهیم. این تابع دو خروجی میدهد که اولی همان متغییر یا state مان است و دومی تابعیست که با آن میتوانیم state مان را تغییر دهیم (مانند setState).
...
در React فرم‌ها تفاوت عمده‌ای با فرم‌های عادی ندارند اما دو ویژگی جزئی در آن‌ها وجود دارد:
