...
```
<p dir="rtl" style="position:right;">
query بالا بعد از پردازش به یک آبجکت user به شکل زیر تبدیل شده و   به پایگاه داده اضافه می‌شود:
</p>
