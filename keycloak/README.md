...
تا به اینجا توضیحاتی راجع‌به اینکه ابزار keycloak چیست و چه کارایی‌ای دارد و همچین نصب آن را مطرح کردیم. همچنین به سؤال اول بحث یعنی اینکه چگونه می‌توان SSO را برای یک کاربر نیز فعال کرد را با استفاده از یک مثال و ساخت کلاینت و کاربر به نمایش گذاشتیم. حال به پیکربندی این ابزار می‌پردازیم.
