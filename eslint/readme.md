...
با استفاده از warn در هنگام نقض این قانون به جای نشان دادن خطا صرفا یک هشدار به آنها نشان داده می‌شود
...
با مشخص کردن این کانفیگ eslint کد های مارا بر اساس نسخه مشخص شده داوری می‌کند در این کانفیگ از ecmaVersion برای زبان js استفاده می‌شود.
...
در مثال بالا فایل های js ما کد های بر اساس ورژن 5 ecma داوری می‌شود.
