...
<p dir = "RTL">
    ESLint یک Linter بسیار محبوب و متن‌باز برای جاوا اسکریپت و تایپ اسکریپت است که می‌تواند کد این زبان‌ها را تحلیل کند و هشدارها و خطاهایی براساس شدت نقض قواعد مختلف ارائه دهد که باعث میشود کدی بهتر با احتمال خطای کمتری توسط توسعه دهنده نوشته شود.
</p>
...
```
 <p>
 بعد از اجرا دستور npm init @eslint/config در دایرکتوری پروژه شما یک فایل .eslintrc.{js,yml,json} ساخته خواهد شد که درآن می‌توانید قانون ها و سطح آنها رو مشخص کنید.
 <p>
...
قوانین بالا به الزام استفاده از semicolon و استفاده از double quote اشاره می‌کنید که درصورت عدم رعایت آنها در ادیتور خود خطای متناسب با این قوانین را مشاهده خواهید کرد
...
با مشخص کردن این کانفیگ eslint کد های مارا بر اساس نسخه مشخص شده داوری می‌کند در این کانفیگ از ecmaVersion برای زبان js استفاده میشود.
