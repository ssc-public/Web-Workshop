...
![معماری MVC در Spring](mvc-architecture.jpeg)
...
Dispatcher Servlet  کنترل‌کننده اصلی است که فرآیند کامل پردازش درخواست‌ها و پاسخ‌ها را مدیریت می‌کند. حالا سؤال این است که کنترل‌کننده اصلی (Front Controller) چیست؟
...
![Dispatcher Servlet](dispatcher-servlet.jpeg)
