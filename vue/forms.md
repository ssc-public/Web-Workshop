...
هنگامی که با فرم ها در فرانت‌اند سروکار داریم، اغلب نیاز داریم که حالت عناصر ورودی فرم را با استیت مربوطه در جاوا اسکریپت همگام سازی کنیم. bind کردن مقادیر و تغییر event listener ها به صورت دستی می‌تواند دشوار باشد:
...
/>
```
این true-value و false-value ویژگی‌های مخصوص Vue هستند که فقط با v-model کار می کنند. در اینجا مقدار toggle با تیک زدن yes و در صورت برداشتن تیک،no  تنظیم می‌شود. همچنین می‌توانید آن‌ها را با استفاده از v-bind به مقادیر پویا متصل کنید:
