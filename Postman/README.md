...
5. بر روی دکمه‌ی "Save" کلیک کنید تا تغییرات اعمال شوند.
...
1. در سازنده‌ی درخواست، بر روی تب "Scripts" کلیک کنید.
2. در قسمت "Post-response"، کد زیر را اضافه کنید:
<div dir="ltr">
...
برای دیدن مستندات:
1. در نوار کناری، بر روی دکمه‌ی سه نقطه‌ای مقابل نام مجموعه‌ی خود کلیک کنید.
2. گزینه‌ی "View documentation" را از منوی کشویی انتخاب کنید.

در صورت نیاز، می‌توانید به صورت دستی مستندات را ادیت کنید. اگر می‌خواهید این مستندات را به اشتراک بگذارید، بر روی دکمه‌ی "Publish" در گوشه بالا سمت راست کلیک کنید.
