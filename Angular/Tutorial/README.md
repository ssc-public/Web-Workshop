...
<br>
✅ ngOnChange : زمانی که مقدار یک @Input تغییر میکند یا بخواهیم اطلاعات دیتایی تغییر کرده در کامپوننت پدر را به اطلاع کامپوننت پسر بفرستیم، از آن استفاده می‌کنیم.
