...
**در ادامه به بررسي هر كدام از قسمت هاي اين ساختار مي پردازيم:**
...
- **test.ts**: این نقطه ورود اصلی برای تست‌های واحد شما است. این دارای پیکربندی سفارشی است که ممکن است غیرمألوف باشد، اما این چیزی نیست که باید ویرایش کنید. اکثر اوقات شما هرگز نیازی به ویرایش آن ندارید.
