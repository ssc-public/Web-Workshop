...
### توضیحات تکمیلی
  ...
  - در بخش styleUrls، همان‌طور که از اسمش مشخص است، می‌توانیم چند کلاس css را داشته باشیم. همچنین این امکان را داریم به مانند Template، در این بخش از styles[] استفاده کنیم و کد های scss را درون آن بنویسیم.
