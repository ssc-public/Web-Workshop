...
✅<b>queryparams:</b> برای ارسال یک سری دیتا از طریق url به یک component، باید داده ها را بعد از پایان url , قرار دادن ؟، به صورت key : value وارد کنیم و اگر چندتا داشته باشیم، باید بین آنها & بگذاریم:
<div dir="ltr">
...
✅ در حالت عادی اگر در کامپوننت های مختلف از سرویس استفاده کنیم، چندین و چند آبجکت ساخته می‌شود. برای حل این مشکل چند راه حل داریم که در ادامه به آنها اشاره می‌کنیم:
