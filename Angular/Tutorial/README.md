...
```
  ...
  - <b>پیاده سازی switch-case:</b> با switch-case در اکثر زبان های برنامه نویسی آشنا هستیم و کاربرد ان در اینجا هم به مانند دیگر زبان هاست. در تگ والد، [ngswitch] را به شکل property-binding می نویسیم. همچنین property مدنظر را ابتدا در typescript تعریف می‌کنیم. نمونه ای از پیاده سازی آن به شکل زیر میباشد:
...
<br>
✅ برای ادیت کردن، می‌توانیم از http.put استفاده کنیم. ورودی های آن شامل آدرس api به مانند Delete بعنوان ورودی اول و متغیرها بعنوان ورودی دوم میباشد.
