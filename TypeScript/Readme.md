...
در این الگو‌های یک ستاره به معنای هر تعداد کاراکتر در یک سطح از فولدر‌ها هست. یک علامت سؤال به معنای یک کاراکتر است و دو ستاره به معنای هر لولی از فولدر‌ها می‌باشد.
...
ممکن است این سؤال پیش بیاید که باید از readonly استفاده کنیم یا const؟ جواب به این سؤال ساده است . کافی است ببینید که میخواهید با یک variable کار کنید یا یک property ! اگر میخواهید با variable کار کنید، باید از const برای اینکار استفاده کنید . در غیر این صورت باید از readonly استفاده شود !
