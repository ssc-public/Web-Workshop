...
> یادداشت نگهداری: بخش نمونه با `keycloak-spring-boot-starter` و `KeycloakWebSecurityConfigurerAdapter` بر اساس آداپتر قدیمی Keycloak نوشته شده است. Keycloak در سال ۲۰۲۲ آداپترهای OpenID Connect Java را deprecated اعلام کرد و در به‌روزرسانی ۲۰۲۳، Spring Security را به عنوان مسیر OAuth و OpenID Connect در Spring نام برد. برای پروژه‌های جدید Spring Boot، این بخش را به عنوان زمینه تاریخی بخوانید و سراغ پیکربندی Spring Security بروید.
...
4. [Deprecation of Keycloak adapters](https://www.keycloak.org/2022/02/adapter-deprecation)
5. [Update on deprecation of Keycloak adapters](https://www.keycloak.org/2023/03/adapter-deprecation-update)
