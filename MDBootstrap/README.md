...
## مودال‌ها (Modal)
مودال‌ها ابزارهایی هستند که اطلاعات اضافه را در قالب یک pop-up نمایش می‌دهند. چند نمونه از کاربردهای مودال‌ها در نمایش پیام‌های موفقیت یا شکست، پرسش سؤال و درخواست تایید از کاربر و ... می‌باشد.
