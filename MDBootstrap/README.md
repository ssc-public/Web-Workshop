...
مقدار span شدن ستون‌ها - اگر بخواهیم یک ستون مساحتی بیشتر از یک دوازدهم عرض صفحه (مقدار پیش‌فرض) را اشغال کند، کلاس ستون را به شکل col-md-x می‌نویسیم که در آن x یک عدد از ۱ تا ۱۲ است و پس از اعمال این کلاس، عرض ستون برابر x دوازدهم کل صفحه خواهد شد.
...
همان‌طور که می‌دانیم این کتابخانه از تعداد زیادی کلاس css تشکیل شده که با اعمال آن‌ها روی تگ‌های htmlمان می‌توانیم استایل‌های آماده‌ی این کتابخانه را به آن‌ها اعمال کنیم. برای اعمال رنگ‌های مختلف، کافیست کلاسی به نام `itemName-colorName` را به آن اضافه کنیم.
