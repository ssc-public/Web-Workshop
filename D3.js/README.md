...
## فهرست
  ...
  - [انتخاب DOM](#انتخاب-dom)
    - [انتخاب تگ d3.select](#انتخاب-تگ-d3select)
    - [انتخاب تمام DOMها d3.selectAll](#انتخاب-تمام-domها-d3selectall)
  ...
  - [خواندن داده‌ها از فایل در D3](#خواندن-داده‌ها-از-فایل-در-d3)
    - [تابع ()d3.csv](#تابع-d3csv)
    - [تابع ()d3.json](#تابع-d3json)
    - [تابع ()d3.tsv](#تابع-d3tsv)
    - [تابع ()d3.xml](#تابع-d3xml)
    - [بایند کردن داده‌های Load شده](#بایند-کردن-داده‌های-load-شده)
  ...
  - [مقیاس در D3](#مقیاس-در-d3)
    - [تابع ()d3.scaleLinear](#تابع-d3scalelinear)
  - [محور‌های نمودار در D3](#محور‌های-نمودار-در-d3)
    - [تابع d3.axisTop](#تابع-d3axistop)
    - [تابع d3.axisRight](#تابع-d3axisright)
    - [تابع d3.axisBottom](#تابع-d3axisbottom)
    - [تابع d3.axisLeft](#تابع-d3axisleft)
  - [ساختن نمودار میله‌ای](#ساختن-نمودار-میله‌ای)
  - [رسم نمودار دایره‌ای با D3](#رسم-نمودار-دایره‌ای-با-d3)
    - [مسیر در SVG](#مسیر-در-svg)
    - [تابع d3.scaleOrdinal](#تابع-d3scaleordinal)
    - [تابع d3.pie](#تابع-d3pie)
    - [تابع d3.arc](#تابع-d3arc)
  - [منابع](#منابع)
...
این کد DOM ای که آی‌دی آن p2 است را انتخاب می‌کند و css آن را تغییر می‌دهد. پس با گذاشتن # در ابتدای ورودی مشخص می‌کند که دنبال DOM با id مشخص شده بگرد.  
