...
## چگونه باید اپلیکیشن خودمون رو به یک container  (چگونه Image خودمان را بسازیم)اضافه کنیم ؟
...
در واقع Dockerfile شامل چند خط می‌باشد که هر خط شامل یک INSTRUCTION که تمامی حروف آن بزرگ و یک ARGUMENT می‌باشد.
