...
# مثالی از docker-compose

در این نوشته قرار است تا **وبلاگ ساده‌ای** را که بکِ آن با جنگو رست و فرانتش با ری‌اکت زده، به وسیله‌ی docker-compose اجرا کنیم.
...
serviceهای معروف دیگری از جمله database هم وجود دارد که البته در ساختن این وبلاگ، به آن احتیاجی نداریم.
