...
2. [معرفی کلی OAuth2 و ابزار گیت‌هاب در Spring Boot](#معرفی-کلی-oauth2-و-ابزار-گیت‌هاب-در-spring-boot)  
3. [ایجاد پروژه در IntelliJ و نیازمندی‌ها](#ایجاد-پروژه-در-intellij-و-نیازمندی‌ها)  
